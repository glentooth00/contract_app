...
<div class="main-layout ">
    ...
    <div class="content-area">
        ...
        <div class="d-flex col-md-12 gap-2">
            ...
            <div class="p-3" id="suspend" style="margin-left:6em;">
    ...
    padding: 5px;
    float: right;>
            <button class=" btn btn-warning mb-2">Suspend</button>
        ...
        <?php if ($department === $getContract['uploader_department'] || $department === $getContract['department_assigned'] || $department === $getContract['implementing_dept']) { ?>
            <div class="gap-1"><?php if ($getContract['contract_status'] === 'Expired') { ?>
                    ...
                    <?php endif; ?>
                    <?php if ($getContract['contract_type'] === TRANS_RENT): ?> <span id="add"
                            style="float:inline-end;display:inline;" data-bs-toggle="modal" data-bs-target="#transformerModal"> <i
                                class="fa fa-plus" aria-hidden="true" style="width:40px;font-size:25px;"></i> </span>
 ...
 margin-left: -5em;
            ...
            <div class="modal-body">
                < ?php $department=$_SESSION['department'] ?? null; ?>
                    <form action="contracts/transformerRent.php" method="post" enctype="multipart/form-data"><input
                            type="hidden" class="form-control" name="contract_type" value="<?= TEMP_LIGHTING ?>"
                            readonly>
                        <div class="col-md-12 d-block gap-2">
                            <div class="col-md-12 d-flex gap-2 row justify-content-center">
                                <div class="col-md-3 p-2" style="width: 13em;">
                                ...
                                <div class="col-md-3 p-2" style="width: 13em;">
                                    <div>
                                        <lable class="badge text-muted">TC No.</lable><input type="text"
                                            class="form-control" name="tc_no" value="<?= $getContract['tc_no'] ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-3 p-2" style="width: 13em;">
                                    <div>
                                        <lable class="badge text-muted">Account no.</lable><input type="text"
                                            class="form-control" value="<?= $getContract['account_no'] ?>"
                            ...
                            <div class="col-md-12 d-flex gap-4 row justify-content-center">
                                ...
                                <div class="col-md-5 p-2">
                                    <div>
                                        <lable class="badge text-muted">Contract file</lable><input
                                            id="contractFileInput" type="file" class="form-control" name="contract_file"
                                            style="width: 16.7em;" required>
                                    </div>
                                </div>
                                <div class="col-md-4 p-2">
                                    <div>
                                        < ?php $userid; $getUser=(new UserController)->getUserById($userid);

                                            // var_dump($getUser['firstname']);
                                            ?><input type="hidden" id="date_start" class="form-control"
                                                name="uploader_id" value="<?= $userid ?>"><input type="hidden"
                                                id="date_start" class="form-control" name="uploader"
                                                value="<?= $getUser['firstname'] . ' ' . $getUser['middlename'] . ' ' . $getUser['lastname'] ?>"><input
                                                type="hidden" id="date_start" class="form-control" name="uploader_dept"
                                                value="<?= $department ?>" required>
                                    </div>
...
< ?php if (isset($_SESSION['notification'])): ?>
    <div id="notification"
        ...
        <!-- Close Button --><button type="button" class="btn-close" data-bs-dismiss="alert"
            aria-label="Close"></button>
    </div>
