        ...
        <div class="mt-3 col-md-12 d-flex gap-5">
            ...
            <div class="row col-md-3">
                <div class="mt-3">
                    ...
                    <input type="text" id="uploadingDept" style="margin-left:9px;" class="form-control pl-5"
            ...
            <div class="row col-md-3">
                <div class="mt-3">
                    ...
                    <input type="text" id="uploadedBy" style="margin-left:9px;" class="form-control pl-5"
...
<script>
    ...
    document.getElementById('save').addEventListener('click', function () {
        ...
        const uploadingDept = document.getElementById('uploadingDept');
        const nameInput = document.getElementById('contractName');
        const startDate = document.getElementById('startDate');
        const endDate = document.getElementById('endDate');
        ...
        const uploadingDeptValue = encodeURIComponent(uploadingDept?.value || '');
        const uploadedByValue = encodeURIComponent(uploadedBy?.value || '');

        // Redirect with query parameters
        window.location.href = `contracts/update.php?id=${contract_id}&name=${contractName}&start=${contractStart}&end=${contractEnd}&dept=${department}&uploaderDept=${uploadingDeptValue}&uploadedBy=${uploadedByValue}`;
    });
