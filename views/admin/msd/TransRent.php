...
<div class="pageContent">
    ...
    <div class="mainContent">
        ...
        <?php 
            $start = new DateTime(!empty($tempLight['contract_start']) ? $tempLight['contract_start'] : $tempLight['rent_start']);
            $end = new DateTime(!empty($tempLight['contract_end']) ? $tempLight['contract_end'] : $tempLight['rent_end']);
        ...
        <div class="mt-3 col-md-12 d-flex gap-5">
            ...
            <div class="row col-md-2" >
                <div class="mt-3">
                    ...
                    <?php
                    $rawStartDate = !empty($tempLight['contract_start']) ? $tempLight['contract_start'] : $tempLight['rent_start'];
                    $formattedDate = date('Y-m-d', strtotime($rawStartDate));
                    ?>
            ...
            <div class="row col-md-2" >
                <div class="mt-3">
                        ...
                        <?php
                        $rawEndDate = !empty($tempLight['contract_end']) ? $tempLight['contract_end'] : $tempLight['rent_end'];
                        $formattedDateend = date('Y-m-d', strtotime($rawEndDate));
                        ?>
        ...
        $startDate = !empty($tempLight['contract_start']) ? $tempLight['contract_start'] : $tempLight['rent_start'];
        $endDate = !empty($tempLight['contract_end']) ? $tempLight['contract_end'] : $tempLight['rent_end'];
                $today = new DateTime();
    ...
    <div class="mt-3 float-end" style="margin-left: 90%;">
        ...
        <?php if ($dept === 'ISD-MSD'): ?>
            ...
            <?php if ($remainingDays <= 3 && $remainingDays >= 0): ?>
