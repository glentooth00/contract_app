                            ...
                            <tr>
                                ...
                                <td style="text-align: center !important;">
                                    <span class="badge text-muted">
                                        <?= isset($contract['contract_start']) ? (new DateTime($contract['contract_start']))->format('M-d-Y') : 'N/A' ?>
                                    </span>
                                </td>
                                <td style="text-align: center !important;">
                                    <span class="badge text-muted">
                                        <?= isset($contract['contract_end']) ? (new DateTime($contract['contract_end']))->format('M-d-Y') : 'N/A' ?>
                                    </span>
                                </td>
