        ...
        <span class="p-1 d-flex float-end" style="margin-top: -2.5em;">
            ...
            <a href="pending_updates.php" style="text-decoration: none;">
                ...
                border-radius: 50%; width: 20px; height: 20px; font-size: 12px;">
                    ...
                    <?php endif; ?>
                    <img width="25px" src="<?= image_source ?>../../../public/images/bell.svg"
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl" role="document">
                                                ...
                                                <div class="col-md-6 card p-3" style="background-color: #ECFAE5;">
                                                    <div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="badge text-muted float-start">Remaining
                                                                    days</label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="badge text-muted float-start">Contract
                                                                    Price</label>
                                                                <input type="text"
                                                                    value="<?= $getContractFromContracts['contractPrice'] ?? '' ?>"
                                                                    class="form-control" readonly>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="badge text-muted float-start">Contract
                                                                    Type</label>
                                                                <input type="text"
                                                                    value="<?= $getContractFromContracts['contract_type'] ?>"
                                                                    class="form-control" readonly>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label class="badge text-muted float-start">Procurement
                                                                    Mode</label>
                                                                <input type="text"
                                                                    value="<?= $getContractFromContracts['procurementMode'] ?>"
                                                                    class="form-control" readonly>
                                                            </div>

                                                            <div class="mb-3">
                                                                <label class="badge text-muted float-start">Current
                                                                    Supplier</label>
                                                                <input type="text"
                                                                    value="<?= $getContractFromContracts['supplier'] ?>"
                                                                    class="form-control" readonly>
                                                            </div>
                                                                ...
                                                                <div class="d-flex gap-2">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <?php if ($getPendingUpdate['rent_start'] === '1900-01-01' ?? $getPendingUpdate['rent_start']): ?>
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <label
                                                                            ...
                                                                            Price</label>
                                                                        <input type="text"
                                                                            value="<?= $getPendingUpdate['total_cost'] ?>"
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <label
                                                                            ...
                                                                            Mode</label>
                                                                        <input type="text"
                                                                            value="<?= $getPendingUpdate['proc_mode'] ?>"
                                                                            name="procurementMode" class="form-control"
                                                                            readonly>
                                                                    </div>
                                                                    <?php endif; ?>
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <label
                                                                            class="badge text-muted float-start mt-2">Updated
                                                                            Supplier</label>
                                                                        <input type="text"
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="modal-footer">
                                            <?php if ($userRole == CHIEF): ?>
                                            <span class="badge bg-secondary text-white fs-5 "
                                                style="margin-left:15em;">Waiting for approval</span>
                                            <?php endif; ?>
