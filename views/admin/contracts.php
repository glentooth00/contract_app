...
<div class="pageContent">
    ...
    <div class="mainContent">
        ...
        <div class="mt-3" id="content">
            ...
            <a class="btn text-white mb-2 p-2" data-mdb-ripple-init style="background-color: #118B50; box-shadow: 0 4px 6px rgb(59 92 70 / 80%);" href="#!" role="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <table class="table table-striped table-hover border p-2">
    <thead>
        <tr>
            <th>Contract Name</th>
            <th>Type</th>
        ...
        <button class="btn btn-primary badge p-2" data-bs-toggle="modal" data-bs-target="#fileModal<?= $contract['id'] ?>" style="text-align: center !important;">
            View file
                ...
                <?php endif; ?>
                    ...
                    <td style="text-align: center !important;">
                        <a href="contracts/delete.php?id=<?= $contract['id'] ?>" class="btn btn-success badge p-2" style="width:4em;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        <a id="delete" data-id="<?= $contract['id'] ?>" class="btn btn-danger badge p-2" style="width:4em;">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12 d-flex gap-2 p-3">
            <div class="col-md-6 p-2">
                <div class="mb-3">
                    <label class="badge text-muted">Contact</label>
