        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="dotMenu" onclick="toggleView()" id="dotMenu">
                ...
                <div id="dropMenu">
                    <ul>
                        <li>
                            <a href="" class="w-100" data-toggle="modal" data-target="#suspendModal"><img
                                    src="../../../public/images/suspendFile.svg" width="20px"><small id=""
                                    class="p-2 mb-5">Suspend Contract</small></a>
                        </li>
                        <li>
                            <a href="" class="w-100"><img src="../../../public/images/bell.svg" width="20px"><small
